...
from bed_properties import export_centroids
...
bpy.ops.object.select_by_type( type = 'SPHERE')
...
export_centroids("centroids.txt")
...
bpy.ops.export_mesh.stl(filepath=parameters.file_path, check_existing=True, axis_forward='X', axis_up='Z', filter_glob= ".STL", global_scale=1, ascii=True, use_mesh_modifiers=True)
