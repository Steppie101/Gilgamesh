...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 23 16:16:20 2025
...
def Box_Mesh(mesh_file):
    ...
    xlength = xmax - xmin + 0.01
    ylength = ymax - ymin + 0.01
    zlength = zmax - zmin + 0.01
...
def Remeshing_Corners(mesh_file):
    ...
    remeshed_mesh = pm.remesh_surface(
            mesh_file,
            ...
            verbose=False)
    remeshed_mesh.write("remeshed_mesh.stl")
    
    remeshed_mesh = trimesh.load("remeshed_mesh.stl")
